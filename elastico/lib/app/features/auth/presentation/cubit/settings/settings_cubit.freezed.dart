...
abstract class $SettingsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isDarkTheme, String languageCode});
}
...
class _$SettingsStateImpl implements _SettingsState {
  const _$SettingsStateImpl(
      {required this.isDarkTheme, required this.languageCode});
  ...
  @override
  String toString() {
    return 'SettingsState(isDarkTheme: $isDarkTheme, languageCode: $languageCode)';
  }
...
abstract class _SettingsState implements SettingsState {
  const factory _SettingsState(
      ...
      required final String languageCode}) = _$SettingsStateImpl;
