...
class _$GetCartImpl implements _GetCart {
  const _$GetCartImpl({this.isReload = false});
...
abstract class _GetCart implements CartEvent {
  const factory _GetCart({final bool isReload}) = _$GetCartImpl;
...
class _$AddToCartImpl implements _AddToCart {
  const _$AddToCartImpl(this.cartItem);
...
abstract class _AddToCart implements CartEvent {
  const factory _AddToCart(final CartItem cartItem) = _$AddToCartImpl;
...
class _$RemoveFromCartImpl implements _RemoveFromCart {
  const _$RemoveFromCartImpl(this.cartId, {this.removeForever = false});
...
abstract class _RemoveFromCart implements CartEvent {
  const factory _RemoveFromCart(final String cartId,
      {final bool removeForever}) = _$RemoveFromCartImpl;
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required final List<CartItem> cart}) : _cart = cart;
...
abstract class _Loaded implements CartState {
  const factory _Loaded({required final List<CartItem> cart}) = _$LoadedImpl;
