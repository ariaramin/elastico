...
import 'package:elastico/app/core/helpers/auth_helper.dart' as _i21;
...
import 'package:elastico/app/features/auth/domain/repositories/auth_repository.dart'
    as _i22;
import 'package:elastico/app/features/auth/domain/usecases/login.dart' as _i42;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i20.AuthDataSource>(
        () => _i20.AuthDatasourceImpl(gh<_i8.PocketBaseHelper>()));
    gh.lazySingleton<_i21.AuthHelper>(() => _i21.AuthHelper(
          gh<_i7.PocketBase>(),
          gh<_i4.FlutterSecureStorage>(),
        ));
    gh.factory<_i22.AuthRepository>(
        () => _i23.AuthRepositoryImpl(gh<_i20.AuthDataSource>()));
    gh.factory<_i24.CartDatasource>(() => _i24.CartDatasourceImpl(
          gh<_i5.HiveHelper>(),
          gh<_i21.AuthHelper>(),
        ));
    gh.factory<_i25.CartRepository>(
        () => _i26.CartRepositoryImpl(gh<_i24.CartDatasource>()));
    gh.factory<_i27.CategoryDatasource>(
        () => _i27.CategoryDatasourceImpl(gh<_i8.PocketBaseHelper>()));
    gh.factory<_i28.CategoryRepository>(
        () => _i29.CategoryRepositoryImpl(gh<_i27.CategoryDatasource>()));
    gh.factory<_i30.CommentDatasource>(
        () => _i30.CommentDatasourceImpl(gh<_i8.PocketBaseHelper>()));
    gh.factory<_i31.CommentRepository>(
        () => _i32.CommentRepositoryImpl(gh<_i30.CommentDatasource>()));
    gh.factory<_i33.GetCart>(() => _i33.GetCart(gh<_i25.CartRepository>()));
    gh.factory<_i34.GetMainCategories>(
        () => _i34.GetMainCategories(gh<_i28.CategoryRepository>()));
    gh.factory<_i35.GetProduct>(
        () => _i35.GetProduct(gh<_i13.ProductRepository>()));
    gh.factory<_i36.GetProductComments>(
        () => _i36.GetProductComments(gh<_i31.CommentRepository>()));
    ...
    gh.factory<_i39.HomeDatasource>(
        () => _i39.HomeDatasourceImpl(gh<_i8.PocketBaseHelper>()));
    gh.factory<_i40.HomeRepository>(
        () => _i41.HomeRepositoryImpl(gh<_i39.HomeDatasource>()));
    gh.factory<_i42.Login>(() => _i42.Login(gh<_i22.AuthRepository>()));
    gh.factory<_i43.Register>(() => _i43.Register(gh<_i22.AuthRepository>()));
    gh.factory<_i44.RemoveFromCart>(
        () => _i44.RemoveFromCart(gh<_i25.CartRepository>()));
    gh.factory<_i45.SearchProduct>(
        () => _i45.SearchProduct(gh<_i16.SearchRepository>()));
    gh.factory<_i46.WishlistDatasource>(() => _i46.WishlistDatasourceImpl(
          gh<_i5.HiveHelper>(),
          gh<_i21.AuthHelper>(),
        ));
    gh.factory<_i47.WishlistRepository>(
        () => _i48.WishlistRepositoryImpl(gh<_i46.WishlistDatasource>()));
    gh.factory<_i49.AddToCart>(() => _i49.AddToCart(gh<_i25.CartRepository>()));
    gh.factory<_i50.AddToWishlist>(
        () => _i50.AddToWishlist(gh<_i47.WishlistRepository>()));
    ...
    gh.factory<_i52.GetHomeData>(
        () => _i52.GetHomeData(gh<_i40.HomeRepository>()));
    gh.factory<_i53.GetWishlist>(
        () => _i53.GetWishlist(gh<_i47.WishlistRepository>()));
    gh.factory<_i54.RemoveFromWishlist>(
        () => _i54.RemoveFromWishlist(gh<_i47.WishlistRepository>()));
    gh.lazySingleton<_i55.WishlistBloc>(() => _i55.WishlistBloc(
          gh<_i53.GetWishlist>(),
          gh<_i50.AddToWishlist>(),
