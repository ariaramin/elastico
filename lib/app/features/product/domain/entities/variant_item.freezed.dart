...
/// @nodoc
abstract class _$$_VariantItemCopyWith<$Res>
    implements $VariantItemCopyWith<$Res> {
  factory _$$_VariantItemCopyWith(
          _$_VariantItem value, $Res Function(_$_VariantItem) then) =
      __$$_VariantItemCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id, String title, String value, int priceChange, int quantity});
...
/// @nodoc
class __$$_VariantItemCopyWithImpl<$Res>
    extends _$VariantItemCopyWithImpl<$Res, _$_VariantItem>
    implements _$$_VariantItemCopyWith<$Res> {
  __$$_VariantItemCopyWithImpl(
      _$_VariantItem _value, $Res Function(_$_VariantItem) _then)
      : super(_value, _then);
...
class _$_VariantItem implements _VariantItem {
  const _$_VariantItem(
      {required this.id,
      required this.title,
      required this.value,
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_VariantItemCopyWith<_$_VariantItem> get copyWith =>
      __$$_VariantItemCopyWithImpl<_$_VariantItem>(this, _$identity);
}
...
abstract class _VariantItem implements VariantItem {
  const factory _VariantItem(
      ...
      required final int quantity}) = _$_VariantItem;
