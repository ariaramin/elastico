...
class _$_Banner implements _Banner {
  const _$_Banner({required this.id, required this.thumbnail});
  ...
  @override
  String toString() {
    return 'Banner(id: $id, thumbnail: $thumbnail)';
  }
...
abstract class _Banner implements Banner {
  const factory _Banner(
      {required final String id, required final String thumbnail}) = _$_Banner;
